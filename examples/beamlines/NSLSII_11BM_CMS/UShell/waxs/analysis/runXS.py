...
# Protocols.circular_average(ylog=False, plot_range=[0, 3.5, None, None], gridlines=True, label_filename=True)
# Protocols.qr_image(blur=None, colorbar=True, save_data=False, transparent=False, label_filename=True) 
# Protocols.sector_average(angle=-70, dangle=25, show_region=False, label_filename=True) ,
